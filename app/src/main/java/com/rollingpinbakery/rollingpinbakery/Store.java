...
public class Store extends AppCompatActivity
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                        Store.this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
                drawer.addDrawerListener(toggle);
                toggle.syncState();
                NavigationView navigationView = findViewById(R.id.nav_view);
                navigationView.setNavigationItemSelectedListener(Store.this);
    ...
    public void NavCakesCat(View view){
        startActivity(new Intent(this, CakesCategory.class));
    }
    public void NavCookiesCat(View view){
        startActivity(new Intent(this, CookiesCategory.class));
    }
    public void NavPastriesCat(View view){
        startActivity(new Intent(this, PastriesCategory.class));
    }
