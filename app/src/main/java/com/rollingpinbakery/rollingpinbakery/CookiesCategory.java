        ...
        dbReference .addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(product.getProdType().endsWith("Cookie")){
                ...
                if(products.isEmpty()){
                    TextView EmptyCat = findViewById(R.id.NoCookieProd);
                    EmptyCat.setText("There are currently no Cookie products available for purchase");
                }
                else{
